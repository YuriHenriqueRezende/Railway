...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/devalue/index.js';
import destr from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/unctx/dist/index.mjs';
import * as vue$1 from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/vue/index.mjs';
import { version, unref } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/yurih/Documents/vercel/seraiva/node_modules/@unhead/shared/dist/index.mjs';
  ...
  "public": {
    ...
    "auth": {
      "computed": {
        ...
        "pathname": "/api/auth",
        "fullBaseUrl": "http://localhost:8000/api/auth"
      },
      "isEnabled": true,
      "session": {
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/yurih/Documents/vercel/seraiva/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\yurih\\Documents\\vercel\\seraiva","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\yurih\\Documents\\vercel\\seraiva\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\yurih\\Documents\\vercel\\seraiva\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\yurih\\Documents\\vercel\\seraiva\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\yurih\\Documents\\vercel\\seraiva\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _9QwifHZOUE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/yurih/Documents/vercel/seraiva";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _Siw2XUBcnf = (nitroApp) => {
...
const BaseStyle$g = /*@__PURE__*/getDefaultExportFromCjs(basestyle_cjs);
...
var BaseComponentStyle = BaseStyle__default$e["default"].extend({
  name: 'common',
...
var CheckboxStyle = BaseStyle__default$d["default"].extend({
  name: 'checkbox',
  classes: classes$d
});
...
var FloatLabelStyle = BaseStyle__default$c["default"].extend({
  name: 'floatlabel',
  classes: classes$c
});
...
var DataTableStyle = BaseStyle__default$9["default"].extend({
  name: 'datatable',
  classes: classes$9,
...
var AvatarStyle = BaseStyle__default$4["default"].extend({
  name: 'avatar',
  classes: classes$4
});
...
var ProgressSpinnerStyle = BaseStyle__default$3["default"].extend({
  name: 'progressspinner',
  classes: classes$3
});
...
const styles$2 = [
  ,
  BaseStyle$g && BaseStyle$g.getStyleSheet ? BaseStyle$g.getStyleSheet(undefined, styleProps) : '',BaseComponentStyle$1 && BaseComponentStyle$1.getStyleSheet ? BaseComponentStyle$1.getStyleSheet(undefined, styleProps) : '',CheckboxStyle$1 && CheckboxStyle$1.getStyleSheet ? CheckboxStyle$1.getStyleSheet(undefined, styleProps) : '',FloatLabelStyle$1 && FloatLabelStyle$1.getStyleSheet ? FloatLabelStyle$1.getStyleSheet(undefined, styleProps) : '',InputTextStyle$1 && InputTextStyle$1.getStyleSheet ? InputTextStyle$1.getStyleSheet(undefined, styleProps) : '',ButtonStyle$1 && ButtonStyle$1.getStyleSheet ? ButtonStyle$1.getStyleSheet(undefined, styleProps) : '',DataTableStyle$1 && DataTableStyle$1.getStyleSheet ? DataTableStyle$1.getStyleSheet(undefined, styleProps) : '',OverlayPanelStyle$1 && OverlayPanelStyle$1.getStyleSheet ? OverlayPanelStyle$1.getStyleSheet(undefined, styleProps) : '',MenubarStyle$1 && MenubarStyle$1.getStyleSheet ? MenubarStyle$1.getStyleSheet(undefined, styleProps) : '',MessageStyle$1 && MessageStyle$1.getStyleSheet ? MessageStyle$1.getStyleSheet(undefined, styleProps) : '',ToastStyle$1 && ToastStyle$1.getStyleSheet ? ToastStyle$1.getStyleSheet(undefined, styleProps) : '',AvatarStyle$1 && AvatarStyle$1.getStyleSheet ? AvatarStyle$1.getStyleSheet(undefined, styleProps) : '',ProgressSpinnerStyle$1 && ProgressSpinnerStyle$1.getStyleSheet ? ProgressSpinnerStyle$1.getStyleSheet(undefined, styleProps) : '',BadgeDirectiveStyle$1 && BadgeDirectiveStyle$1.getStyleSheet ? BadgeDirectiveStyle$1.getStyleSheet(undefined, styleProps) : '',TooltipStyle$1 && TooltipStyle$1.getStyleSheet ? TooltipStyle$1.getStyleSheet(undefined, styleProps) : '',RippleStyle$1 && RippleStyle$1.getStyleSheet ? RippleStyle$1.getStyleSheet(undefined, styleProps) : '',StyleClassStyle$1 && StyleClassStyle$1.getStyleSheet ? StyleClassStyle$1.getStyleSheet(undefined, styleProps) : '',FocusTrapStyle$1 && FocusTrapStyle$1.getStyleSheet ? FocusTrapStyle$1.getStyleSheet(undefined, styleProps) : '',AnimateOnScrollStyle$1 && AnimateOnScrollStyle$1.getStyleSheet ? AnimateOnScrollStyle$1.getStyleSheet(undefined, styleProps) : ''
].join('');

const defineNitroPlugin = (def) => def;
const _yVieUfFHSP = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_Lj4GwJ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Lj4GwJ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Lj4GwJ, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/yurih/Documents/vercel/seraiva/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/yurih/Documents/vercel/seraiva/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
